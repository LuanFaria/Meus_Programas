...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(397, 465)
        MainWindow.setAccessibleName("")
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.bt_mp4 = QtWidgets.QPushButton(self.centralwidget)
        self.bt_mp4.setGeometry(QtCore.QRect(250, 240, 111, 51))
        self.bt_mp4.setObjectName("bt_mp4")
        self.bt_mp3 = QtWidgets.QPushButton(self.centralwidget)
        self.bt_mp3.setGeometry(QtCore.QRect(40, 240, 111, 51))
        self.bt_mp3.setObjectName("bt_mp3")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(40, 200, 121, 20))
        self.label_2.setObjectName("label_2")
        self.input = QtWidgets.QLineEdit(self.centralwidget)
        self.input.setGeometry(QtCore.QRect(130, 200, 231, 25))
        self.input.setObjectName("input")
        self.titulo = QtWidgets.QLineEdit(self.centralwidget)
        self.titulo.setGeometry(QtCore.QRect(90, 50, 211, 81))
